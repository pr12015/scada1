...
namespace dCom.Modbus.ModbusFunctions
{
	public class WriteSingleRegisterFunction : ModbusFunction
	{
		...
		public override Dictionary<Tuple<PointType, ushort>, ushort> ParseResponse(byte[] response)
		{
            ...
            ModbusWriteCommandParameters mdbParams = (ModbusWriteCommandParameters)CommandParameters;

            retval.Add(new Tuple<PointType, ushort>(PointType.ANALOG_OUTPUT, mdbParams.OutputAddress), mdbParams.Value);
